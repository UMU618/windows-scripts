...
$sl.Colors.UserForegroundColor = [ConsoleColor]::DarkCyan
$sl.Colors.MachineForegroundColor = [ConsoleColor]::DarkGreen
$sl.Colors.DirectoryForegroundColor = [ConsoleColor]::DarkBlue
